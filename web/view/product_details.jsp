					...
					<div id="product_details_slider" class="carousel slide"
						...
						<ol class="carousel-indicators">
							...
							<li class="active" data-target="#product_details_slider"
								data-slide-to="0"
								style="background-image: url(img/main_img/${select_product_mainimg_list});">
							</li>
							<%int count=1; %>
							<c:forEach var="img_item" items="${select_product_img_list}">
								...
								<li data-target="#product_details_slider"
									data-slide-to="<%=count %>"
									style="background-image: url(img/main_img/${img_item});">
								</li>
						...
						<div class="carousel-inner">
							<div class="carousel-item active">
								<a class="gallery_img"
									href="img/main_img/${select_product_mainimg_list}"> <img
									class="d-block w-100"
									src="img/main_img/${select_product_mainimg_list}"
									alt="First slide">
								</a>
							</div>
							<%int count2=2; %>
			...
			<div class="col-12 col-lg-5">
				<div class="single_product_desc">
					...
					<div class="product-meta-data">
						...
						<!-- Avaiable -->
						<p class="avaibility">
							<i class="fa fa-circle"></i>${select_product_list.amount}</p>
					</div>
